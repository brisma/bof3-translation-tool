...
GFX_REINSERT_COMMANDS_COMMON=(
  ...
  "python bof3tool.py tim2raw -i TEMP/GFX/$BIN/AREA104.8.bin.4.2.8b.64w.64x32.128r.tim -o TEMP/GFX/$BIN/AREA104.8.bin.4.2 --tile-width 64 --tile-height 32 --resize-width 64"
...
GFX_REINSERT_COMMANDS_USA=("${GFX_REINSERT_COMMANDS_COMMON[@]}")
...
GFX_REINSERT_COMMANDS_PAL=("${GFX_REINSERT_COMMANDS_COMMON[@]}")
...
GFX_REINSERT_COMMANDS_PSP=("${GFX_REINSERT_COMMANDS_COMMON[@]}")
...
python bof3tool.py split -i TEMP/GFX/$BIN/RAW/AREA104.8.bin.4 -o TEMP/GFX/$BIN/RAW --bpp 8 --tile-width 64 --tile-height 32 --resize-width 256 --quantity 2
...
cp -v TEMP/GFX/$BIN/AREA030.12.bin.4 TEMP/GFX/$BIN/RAW/AREA089.12.bin.4
...
cp -v TEMP/GFX/$BIN/AREA104.8.bin.4.2 TEMP/GFX/$BIN/RAW/AREA104.8.bin.4.2
...
cp -v TEMP/GFX/$BIN/AREA030.12.bin.4 TEMP/GFX/$BIN/RAW/AREA129.12.bin.4
...
python bof3tool.py merge -i TEMP/GFX/$BIN/RAW/AREA030.12.bin.* -o TEMP/BIN/$BIN/AREA030.12.bin --bpp 8 --tile-width 64 --tile-height 32 --resize-width 1024
...
python bof3tool.py merge -i TEMP/GFX/$BIN/RAW/AREA089.12.bin.* -o TEMP/BIN/$BIN/AREA089.12.bin --bpp 8 --tile-width 64 --tile-height 32 --resize-width 1024
...
python bof3tool.py merge -i TEMP/GFX/$BIN/RAW/AREA104.8.bin.4.* -o TEMP/GFX/$BIN/RAW/AREA104.8.bin.4 --bpp 8 --tile-width 64 --tile-height 32 --resize-width 256
rm -f TEMP/GFX/$BIN/RAW/AREA104.8.bin.4.*
python bof3tool.py merge -i TEMP/GFX/$BIN/RAW/AREA104.8.bin.* -o TEMP/BIN/$BIN/AREA104.8.bin --bpp 8 --tile-width 64 --tile-height 32 --resize-width 1024
...
python bof3tool.py merge -i TEMP/GFX/$BIN/RAW/AREA129.12.bin.* -o TEMP/BIN/$BIN/AREA129.12.bin --bpp 8 --tile-width 64 --tile-height 32 --resize-width 1024
