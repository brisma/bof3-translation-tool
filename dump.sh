...
BIN_DUMP_COMMANDS_COMMON=(
  ...
  "python bof3tool.py rawdump -i UNPACKED/$BIN/ETC/BATE/BATE.1.bin -o DUMP/$BIN/BINARY/BATE.1.bin.json --offset 0x7FC0 --quantity 4 --skip 4 --repeat 6 --trim"
  "python bof3tool.py rawdump -i UNPACKED/$BIN/ETC/BATE/BATE.1.bin -o DUMP/$BIN/BINARY/BATE.1.bin.json --offset 0x7FEC --quantity 4 --skip 4 --repeat 16 --trim"
  ...
  "python bof3tool.py rawdump -i UNPACKED/$BIN/ETC/SHISU/SHISU.1.bin -o DUMP/$BIN/BINARY/SHISU.1.bin.json --offset 0x8FE4 --quantity 4 --skip 4 --repeat 6 --trim"
  "python bof3tool.py rawdump -i UNPACKED/$BIN/ETC/SHISU/SHISU.1.bin -o DUMP/$BIN/BINARY/SHISU.1.bin.json --offset 0x9010 --quantity 4 --skip 4 --repeat 16 --trim"
  ...
  "python bof3tool.py rawdump -i UNPACKED/$BIN/ETC/SHOP/SHOP.1.bin -o DUMP/$BIN/BINARY/SHOP.1.bin.json --offset 0x14CBC --quantity 4 --skip 4 --repeat 6 --trim"
  "python bof3tool.py rawdump -i UNPACKED/$BIN/ETC/SHOP/SHOP.1.bin -o DUMP/$BIN/BINARY/SHOP.1.bin.json --offset 0x14CE8 --quantity 4 --skip 4 --repeat 16 --trim"
  ...
  "python bof3tool.py rawdump -i UNPACKED/$BIN/ETC/START/START.9.bin -o DUMP/$BIN/BINARY/START.9.bin.json --offset 0x1BDD8 --quantity 4 --skip 4 --repeat 6 --trim"
  "python bof3tool.py rawdump -i UNPACKED/$BIN/ETC/START/START.9.bin -o DUMP/$BIN/BINARY/START.9.bin.json --offset 0x1BE04 --quantity 4 --skip 4 --repeat 16 --trim"
